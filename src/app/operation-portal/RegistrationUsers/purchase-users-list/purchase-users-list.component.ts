...
@Component({
  templateUrl: './purchase-users-list.component.html',
  styleUrls:['./purchase-users-list.component.css'],
  animations: [appModuleAnimation()]
})
export class PurchaseUsersComponent extends AppComponentBase implements OnInit{
  users: UserDto[] = [];
  keyword = '';
  isActive: boolean | null;
