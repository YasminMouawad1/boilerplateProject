...
import { acceptBulkDialogComponent } from '../accept-application/accept-dailog.component';
import { BsModalRef, BsModalService } from 'ngx-bootstrap/modal';
import { rejectBulkDialogComponent } from './../reject-application/reject-dailog.component'; 

@Component({
  templateUrl: './bulk-on-borading-item.component.html',
  styleUrls:['./bulk-on-borading-item.component.css'],
...
export class bulkOnBoradingITemComponent implements OnInit {
 ...
 isShowMainInfo = abp.auth.isGranted("Pages.Risk.BulkOnBorading.ShowMainInfo ");
  ...
  private showRejectDialog(userItem:any,submitrejectform:any,rejectionValidationForm:any,
    ...
    rejectDialog = this._modalService.show(rejectBulkDialogComponent,{class: 'modal-lg', initialState });
