...
import { rejectLimitReviewDialogComponent } from './../reject-application/reject-dailog.component'; 
...
export class UserItemLimitReviewComponent implements OnInit {
 ...
 isShowRejectBtn = abp.auth.isGranted("Pages.Risk.LimitReview.Reject");
 isShowSaveNoteBtn = abp.auth.isGranted("Pages.Risk.LimitReview.SaveEditNote");
 ...
 isShowMainInfo = abp.auth.isGranted("Pages.Risk.LimitReview.ShowMainInfo");
  ...
  private showRejectDialog(userItem:any,submitrejectform:any,rejectionValidationForm:any,
    ...
    rejectDialog = this._modalService.show(rejectLimitReviewDialogComponent,{class: 'modal-lg', initialState });
