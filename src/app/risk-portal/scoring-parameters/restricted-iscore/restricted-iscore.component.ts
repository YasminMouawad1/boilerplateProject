...
import { addRestrictedIScoreDialogComponent } from './add-dailog/add-dailog.component';

@Component({
  templateUrl: './restricted-iscore.component.html',
  animations: [appModuleAnimation()],
  styleUrls:['./restricted-iscore.component.css'], 
})
export class RestrictedIscoreComponent extends AppComponentBase {
  ...
  constructor(injector: Injector, private UsersService:UsersService,private _modalService: BsModalService) {
    super(injector);
 ...
 activeSystemConfiguration(professtion:any){
      ...
      acceptDialog = this._modalService.show(addRestrictedIScoreDialogComponent,{class: 'modal-lg' });
