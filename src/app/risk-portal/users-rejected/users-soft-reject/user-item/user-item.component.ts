...
import { acceptSoftRejectDialogComponent } from '../accept-application/accept-dailog.component';
import { BsModalRef, BsModalService } from 'ngx-bootstrap/modal';
import { rejectSoftRejectDialogComponent } from './../reject-application/reject-dailog.component';
import { editSoftRejectDialogComponent } from '../edit-application/edit-dailog.component';
...
export class UserItemSoftRejectComponent implements OnInit {
  ...
  private showAcceptDialog(userItem:any,riskapproved:any,riskComment:any,salesRepMessage:any,submitAccept:any): void {
    ...
    debugger
      ...
      acceptDialog = this._modalService.show(acceptSoftRejectDialogComponent,{class: 'modal-lg', initialState });
  ...
  private showRejectDialog(userItem:any,submitrejectform:any,rejectionValidationForm:any,
    ...
    rejectDialog = this._modalService.show(rejectSoftRejectDialogComponent,{class: 'modal-lg', initialState });
  ...
  private showEditDialog(userItem:any,oldRiskApprovedLimit:any,isEditRiskLimit:any,
    ...
    editDialog = this._modalService.show(editSoftRejectDialogComponent,{class: 'modal-lg', initialState });
