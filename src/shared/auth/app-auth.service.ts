...
export class AppAuthService {
    ...
    newLanguage$ = new BehaviorSubject<string>('');

   currentLanguage = this.newLanguage$.asObservable();
    ...
    setNewLanguage(lang:any){ 
          this.newLanguage$.next(lang);
          console.log('set function', this.newLanguage$.value);
    }
